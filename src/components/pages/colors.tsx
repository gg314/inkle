  ...
  return (
    <div>
      <div className="mt-4 mb-4">
        ...
        <p>
          Click a color to toggle its availability. Only "available" colors will
          be shown in the band designer.
        </p>
      </div>
      <div className="mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        {sortColors(colors).map((color: Color) => (
          <div
            key={color.name}
            className={cn(
          ...
          >
            <button
              type="button"
              className="flex items-center cursor-pointer flex-1 bg-transparent border-none p-0 text-left"
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete "{colorToDelete?.name}"? This will
              remove it from your color library and replace it with empty spaces
              in any patterns where it's used. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
