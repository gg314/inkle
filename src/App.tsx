			...
			<div className="flex md:hidden min-h-screen flex-col bg-background">
				...
				<div className="px-6 pt-12 pb-8 text-center">
					...
					<p className="text-muted-foreground text-base leading-relaxed">
						...
						warping draft visually, choose from hundreds of thread colors, and
						preview your band before you warp.
					</p>
				</div>
				...
				{/* Desktop notice */}
				<div className="mx-6 mb-8 rounded-lg bg-muted px-4 py-3 text-sm">
					<strong>Best on desktop.</strong>{" "}
					<span className="text-muted-foreground">
						The designer requires a larger screen to use comfortably. Come back
						on a laptop or desktop to start designing.
					</span>
				</div>
				...
				{/* PDF Resources */}
				<div className="px-6 pb-8">
					<h2 className="text-lg font-semibold mb-4">Free downloads</h2>
					<div className="flex flex-col gap-3">
							...
							>
								...
								<div className="text-left ml-3">
									<div className="font-medium text-sm">
										Blank Pattern Template
									</div>
									<div className="text-xs text-muted-foreground font-normal mt-0.5">
										Printable graph paper for inkle warping drafts
									</div>
								</div>
							</a>
						</Button>
						...
						>
							...
							>
								<FileTextIcon className="h-5 w-5 shrink-0 text-muted-foreground" />
								<div className="text-left ml-3">
									<div className="font-medium text-sm">Build an Inkle Loom</div>
									<div className="text-xs text-muted-foreground font-normal mt-0.5">
										Woodworking plans for building your own inkle loom
									</div>
								</div>
							</a>
						</Button>
				...
				{/* Footer */}
				<div className="mt-auto px-6 py-6 border-t text-center">
					<Button
						asChild
						variant="ghost"
						size="sm"
